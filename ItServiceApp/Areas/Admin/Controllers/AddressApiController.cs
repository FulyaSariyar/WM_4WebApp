...
namespace ItServiceApp.Areas.Admin.Controllers
{
    ...
    public class AddressApiController : Controller
    {
        ...
        {
            var data = _dbContext.Addreses.Where(x => x.UserId == userId);
        ...
        {
            var data = _dbContext.Addreses.Where(x => x.Id == id);
        ...
        {
            var data = _dbContext.Addreses.Find(key);
            if (data == null)
                return BadRequest(new JsonResponseViewModel()
                {
                    IsSuccess = false,
        ...
        public IActionResult Delete(Guid key)
        {
            ...
            _dbContext.Addreses.Remove(data);
